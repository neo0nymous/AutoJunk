...
namespace JNK_Generator
{
    public partial class JNK1 : MetroForm
    {
        public JNK1()
        {
            InitializeComponent();
        ...
        private void JNK1_Load(object sender, EventArgs e)
        {
            /*
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            if (listBox1.Items.Count > 0)
            {
                ...
                {
                    MessageBox.Show("Please choose a data type.", "JNK Generator", MessageBoxButtons.OK);
                    return;
                }
            ...
            {
                MessageBox.Show("No \".cpp\" files were found.", "JNK Generator", MessageBoxButtons.OK);
                return;
            }
        }
        ...
        private void metroButton3_Click(object sender, EventArgs e)
        {
            ...
            if (timer1.Enabled == false)
            {
                ...
                {
                    MessageBox.Show("Place this program in the directory of your \".sln\" file before trying to build.", "JNK Generator", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
            }
            else
                MessageBox.Show("Stop generating junk before trying to build.", "JNK Generator", MessageBoxButtons.OK, MessageBoxIcon.Error);
            return;*/
        }
        ...
        private void metroButton5_Click(object sender, EventArgs e)
        {
            if (listBox1.Items.Count > 0)
            {
                ...
                {
                    MessageBox.Show("Please stop generating junk before trying to remove junk.", "JNK Generator", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
            }
            else
            {
                MessageBox.Show("No \".cpp\" files were found.", "JNK Generator", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        }
...
///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        public void Delete()
        {
            string Pattern = "(// JNK BEGIN)(.*?)(// JNK END)";
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            if (count == listBox1.Items.Count)
            {
                count = 0;
                timer2.Stop();
                MessageBox.Show("Successfully removed all previous junk.", "JNK Generator", MessageBoxButtons.OK);
                return;
            }
            else
            {
